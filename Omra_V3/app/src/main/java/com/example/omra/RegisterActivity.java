...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonreg = findViewById(R.id.rRegisterButton);
        progressBar = findViewById(R.id.progressbar);
        textView = findViewById(R.id.rLoginNow);
        firstname = findViewById(R.id.rEnterFirstName);
        lastname = findViewById(R.id.rEnterLastName);
